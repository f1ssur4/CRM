        ...
        <table class="table" style="margin-top: 2em; width: auto">
            ...
            @foreach($clients as $client)
                <tr>
                    ...
                    <td>
                        <a href="/instructors/@php echo $client->instructor->id @endphp">@php echo $client->instructor->name . ' ' . $client->instructor->surname @endphp</a>
                    </td>
                    <td>@php echo $client->status->title @endphp</td>
                    <td><a href="/clients/@php echo $client->id @endphp">show more</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
