...
<table class="table" style="margin-top: 2em">
    ...
    <tr>
        ...
        <td><div class="rectangle" style="margin-top: 8px;position: fixed;width: 20px;height: 20px;-moz-border-radius: 10px;-webkit-border-radius: 10px;border-radius: 10px;background:@php echo session()->get('color') @endphp;"></div></td>
